...
public class testRoom {
    public static void main (String[] args) {
        Room r1 = new Room("1",3, ROOM_TYPE.STUDENT_MALE, true);
        ...
        TenantRecord tr = new TenantRecord(st1, "hall01", "10");
        System.out.println(tr.getTenant());
        System.out.println(tr.getHallName());
        System.out.println(tr.getRoomNumber());
        System.out.println(st1.preferredRoomType());
